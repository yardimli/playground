				...
				<div class="container">
					<div class="dz-bnr-inr-entry">
						...
						<nav aria-label="breadcrumb" class="breadcrumb-row">
							<ul class="breadcrumb">
								<li class="breadcrumb-item"><a href="index-new.php"> Home</a></li>
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-lg-8 col-md-7 col-sm-12 inner-text">
							<h4 class="title">The DexignZone Terms was updated on 20 July 2022.</h4>
							...
							<aside class="side-bar sticky-top right">
								<div class="service_menu_nav widget style-1">
									<ul class="menu">
										...
										<li class="menu-item active"><a href="terms.php">Terms</a></li>
