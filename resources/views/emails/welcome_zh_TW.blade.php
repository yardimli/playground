...
<div style="display:none;font-size:1px;color:#ffffff;line-height:1px;max-height:0px;max-width:0px;opacity:0;overflow:hidden;"> 很高興看到您加入織音大家庭！ </div>
<div style="background-color:#f9f0e6;">
											...
											<tr>
												<td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
													<div style="font-family:Muli, Arial, sans-serif;font-size:20px;font-weight:400;line-height:30px;text-align:left;color:#333333;">
														<h1 style="margin: 0; font-size: 24px; line-height: normal; font-weight: bold;">一起創造動人的旋律吧</h1>
													</div>
												</td>
											</tr>
											<tr>
												...
												<td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
													<div style="font-family:Muli, Arial, sans-serif;font-size:16px;font-weight:400;line-height:20px;text-align:left;color:#333333;">
														<p style="margin: 0;">
															...
															歡迎加入織音！
															<br><br>
															織音是一個充滿活力和創造力的歌曲製作平台，致力於為您提供最優質的歌曲製作服務。
															我們最大的優勢在於您無需擁有任何音樂知識背景，透過AI技術，人人都可以創作出一首獨一無二的歌曲，成為您送禮、慶祝或表達情感的最新選擇。
															<br><br>
															各位音樂愛好者，你們準備好了嗎？
															<br><br>
															讓我們一起編織美妙的音符，為這個世界帶來更多動人的旋律吧。
														</p>
														<p style="margin-top: 50px;">織音團隊</p>
													</div>
												</td>
											</tr>
											</tbody></table>
	...
	<div style="margin:0px auto;max-width:600px;">
		<table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="width:100%;">
			<tbody>
			<tr>
				<td align="center" style="font-size:0px;padding:20px 25px 5px 25px;word-break:break-word;">
					<!--[if mso | IE]>
					<table
				...
				<td style="direction:ltr;font-size:0px;text-align:center;">
					...
					<div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
						<table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
							...
							<tr>
								<td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
									<div style="font-family:Muli, Arial, sans-serif;font-size:14px;font-weight:400;line-height:20px;text-align:center;color:#616161;">有任何問題、建議或疑慮，請隨時與我們的客服聯繫 : <a href="mailto:support@fictionfusion.io" target="_blank" style="color: #AC7B4C; text-decoration: none;">support@fictionfusion.io</a>
									</div>
