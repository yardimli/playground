...
<div style="display:none;font-size:1px;color:#ffffff;line-height:1px;max-height:0px;max-width:0px;opacity:0;overflow:hidden;"> 申請密碼變更 </div>
                    ...
                    <![endif]-->
							...
							<tr>
								<td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
									<div style="font-family:Roboto, Helvetica, Arial, sans-serif;font-size:24px;font-weight:300;line-height:30px;text-align:left;color:#000000;">重設密碼</div>
								</td>
							</tr>
							<tr>
								<td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
									<div style="font-family:Roboto, Helvetica, Arial, sans-serif;font-size:16px;font-weight:300;line-height:20px;text-align:left;color:#000000;">我們收到您的密碼變更請求，如果您本人沒有申請，請忽略此封信件。<br>
										如果您需要變更密碼。請點擊下面按鈕重設密碼：</div>
								</td>
							</tr>
							<tr>
									...
									<table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;line-height:100%;">
										<tbody><tr>
											<td align="center" bgcolor="#54595f" role="presentation" style="border:none;border-radius:3px;cursor:auto;mso-padding-alt:8px 16px;background:#54595f;" valign="middle">
												<a href="{{ url('/password/reset/'.$token.'?email='.$email) }}" style="display: inline-block; background: #54595f; color: white; font-family: Roboto, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: normal; line-height: 20px; margin: 0; text-decoration: none; text-transform: none; padding: 8px 26px; mso-padding-alt: 0px; border-radius: 3px;" target="_blank"> 重設密碼 </a>
											</td>
										</tr>
										</tbody></table>
								</td>
							...
							<tr>
								<td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
									<div style="font-family:Roboto, Helvetica, Arial, sans-serif;font-size:16px;font-weight:300;line-height:20px;text-align:left;color:#000000;">如果無法開啟連結，請複製以下網址並貼到瀏覽器視窗：</p>
										<p style="margin: 0;"><a href="{{ url('/password/reset/'.$token.'?email='.$email) }}" target="_blank">{{ url('/password/reset/'.$token.'?email='.$email) }}</a></div>
								</td>
							</tr>
							<tr>
								<td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
									<div style="font-family:Roboto, Helvetica, Arial, sans-serif;font-size:16px;font-weight:300;line-height:20px;text-align:left;color:#000000;">祝您有愉快的一天！<br><br><br>織音團隊</div>
								</td>
							</tr>
							</tbody></table>
					</div>
				...
				<td style="direction:ltr;font-size:0px;padding:20px 0;text-align:center;">
					...
					<div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
						<table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
							...
							<tr>
								<td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
									<div style="font-family:Roboto, Helvetica, Arial, sans-serif;font-size:14px;font-weight:300;line-height:20px;text-align:center;color:#fafafa;">如果您沒有在織音創建帳戶，您可以放心的刪除此封信件。</div>
								</td>
							</tr>
							</tbody></table>
					</div>
