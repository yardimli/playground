	...
	<nav class="navbar navbar-expand-lg">
        ...
        <!-- Nav Search END -->
              ...
              <li class="dropdown-divider"></li>
							<li>
								<a class="dropdown-item" href="https://themes.getbootstrap.com/store/FICTION•FUSION/" target="_blank">
              ...
              <li> <a class="dropdown-item" href="messaging.html">Messaging</a></li>
                ...
                <a class="dropdown-item dropdown-toggle" href="#!">Profile</a>
								<ul class="dropdown-menu" data-bs-popper="none">
									<li> <a class="dropdown-item" href="my-books.blade.php">Feed</a> </li>
									<li> <a class="dropdown-item" href="/about">About</a> </li>
									<li> <a class="dropdown-item" href="my-books-connections.html">Connections</a> </li>
									<li> <a class="dropdown-item" href="my-books-media.html">Media</a> </li>
									<li> <a class="dropdown-item" href="my-books-videos.html">Videos</a> </li>
									<li> <a class="dropdown-item" href="my-books-events.html">Events</a> </li>
									<li> <a class="dropdown-item" href="my-books-activity.html">Activity</a> </li>
								</ul>
							</li>
              ...
              <li> <a class="dropdown-item" href="create-page.html">Create a page</a></li>
							...
							<li> <a class="dropdown-item" href="notifications.blade.php">Notifications</a> </li>
              ...
              <li> <a class="dropdown-item" href="privacy_and_terms.blade.php">Privacy & terms</a> </li>
					...
					<li class="nav-item">
						<a class="nav-link" href="my-books-connections.html">My network</a>
					</li>
				</ul>
			</div>
			<!-- Main navbar END -->
                ...
                <ul class="list-group list-group-flush list-unstyled p-2">
                  ...
                  <li>
                    <a href="#" class="list-group-item list-group-item-action rounded d-flex border-0 mb-1 p-3">
                      ...
                      <div class="ms-sm-3">
                        <div class="d-flex">
                          <p class="small mb-2">FICTION•FUSION has 15 like and 1 new activity</p>
        ...
        <li class="nav-item ms-2 dropdown">
          ...
          <ul class="dropdown-menu dropdown-animation dropdown-menu-end pt-3 small me-md-n3" aria-labelledby="profileDropdown">
            ...
            <li class="px-3">
              ...
              <a class="dropdown-item btn btn-primary-soft btn-sm my-2 text-center" href="my-books.blade.php">View profile</a>
            </li>
            <!-- Links -->
