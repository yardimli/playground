					...
					<div class="row">
						...
						<div class="col-lg-8 col-md-7 col-sm-12 inner-text">
							...
							<ul class="list-check primary m-a0">
								<li>The DexignLab Terms was updated on 25 June 2018. Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's </li>
							...
							<aside class="side-bar sticky-top right">
								<div class="service_menu_nav widget style-1">
									<ul class="menu">
										...
										<li class="menu-item active"><a href="{{route('terms')}}">Terms</a></li>
