				...
				<div class="col-lg-6 col-md-6 mb-4">
					<div class="login-area">
						<form>
							...
							<div class="mb-5">
								<small>Your personal data will be used to support your experience throughout this website, to manage
									access to your account, and for other purposes described in our <a href="{{route('privacy-policy')}}">privacy
										policy</a>.</small>
							</div>
							<div class="text-left">
